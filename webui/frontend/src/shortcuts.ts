...
export const SHORTCUT_GROUPS: ShortcutGroup[] = [
  {
    ...
    items: [
      ...
      { keys: ["mod", "alt", "N"], label: "New session", desc: "Open the New session composer (⌘N is reserved by the browser)" },
      { keys: ["mod", "K"], label: "Command palette", desc: "Search sessions and run commands" },
      { keys: ["mod", "1", "…", "9"], label: "Jump to recent session", desc: "⌘1–⌘9 open the matching recent session" },
      { keys: ["mod", "alt", "up"], label: "Previous session", desc: "Select the session above in the sidebar" },
      { keys: ["mod", "alt", "down"], label: "Next session", desc: "Select the session below in the sidebar" },
      { keys: ["mod", "F"], label: "Find in conversation", desc: "Search the current session's messages" },
      { keys: ["mod", "B"], label: "Toggle sidebar", desc: "Show or hide the session sidebar" },
      { keys: ["mod", ","], label: "Open settings", desc: "Appearance, shortcuts, Git and more" },
      { keys: ["mod", "enter"], label: "Approve request", desc: "Approve the pending approval in the open session" },
      { keys: ["mod", "⌫"], label: "Deny request", desc: "Deny the pending approval in the open session" },
