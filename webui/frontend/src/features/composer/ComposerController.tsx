...
export { GoalLoopLauncher } from "./GoalLoopLauncher";
...
export function Composer(props: ComposerProps) {
  ...
  const [launcher, setLauncher] = useState<null | { mode: "goal" | "best"; prompt: string }>(null);
          ...
          openModal(
            isSession
              ...
              : {
                  ...
                  message: text,
                  spec: selectedAgent
                    ? buildSpec({ agent: selectedAgent, access })
                    : "",
                  provider,
                  model,
                  effort,
