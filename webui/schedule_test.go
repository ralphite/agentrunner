...
func TestCadenceOf(t *testing.T) {
	cases := []struct {
		...
		{"interval whole day", driverSpec{Schedule: schedInterval, Interval: "24h"}, "Every 1d"},
		{"interval day plus hour", driverSpec{Schedule: schedInterval, Interval: "25h"}, "Every 1d1h"},
		{"interval multi-day rolls up", driverSpec{Schedule: schedInterval, Interval: "171h"}, "Every 7d3h"},
