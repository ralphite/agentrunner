...
func usage() string {
	return "usage: agentrunner <run|drive|daemon|submit|attach|approve|resume|sessions|events|inspect|trust|record-fixture|accept|--version> [flags] [<spec.yaml> \"task\"]\n"
}
