...
一步完成。active_seconds 定为"LLM/tool 活动区间合并后的墙钟"——
并行批只计一次、待命/审批挂起天然不计（比逐 turn 扣 waiting 配对
更简单且更准）。B 闸真 Gemini：+6/−1 与 workspace 实际行数交叉验证
吻合，证据 `qa/runs/2026-07-11-INC43/`。SPEC 两行、LOG、SPRINT #31
✅；批 1 六项全清。
