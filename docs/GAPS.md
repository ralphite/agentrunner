...
| UJ-24 Web UI 驾驶 AgentRunner | ✅ | INC-19/23/29/38/40/41/57：Codex 式信息架构 + truthful hydration + 四控件 environment composer/selected-ref worktree + Worked/Changes outcome + durable `Working tree / Last turn` review scope + hover actions + 内联审批 + responsive Supervision/recovery + restart-safe Scheduled + structured Run details + responsive/a11y；QA-27/34/36/41/42/43/60 |
