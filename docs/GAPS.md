...
| UJ-24 Web UI 驾驶 AgentRunner | ✅ | INC-19/23/29：Codex 式信息架构 + Changes + 内联审批 + Supervision/recovery + restart-safe Scheduled + structured Run details + concise title + responsive/a11y；QA-27/34/36 |
