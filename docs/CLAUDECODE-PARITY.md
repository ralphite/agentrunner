...
| 35 | Glob/Grep | ripgrep、output_mode/-A/-B/-C/multiline/type | ✅ INC-3 + **INC-22**（2026-07-09）：case_insensitive/glob 过滤/output_mode(content/files_with_matches/count)，QA-30 真机；默认=旧行为 | -A/-B/-C context 与 multiline 余项（#12b） |
