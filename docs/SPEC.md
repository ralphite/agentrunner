...
| Web UI 产品面：Codex 式 New task/Scheduled/Pinned/Projects→task、单一 thread、Changes、deep link、responsive sidebar | ✅ | UJ-24 | INC-19/23 · frontend view-model/timeline tests · QA-27/32 |
...
| Web UI Supervision（goal/agent tree 去重/approval+recovery attention/background，成员只读导航） | ✅ | UJ-18/22/23/24 | INC-19/23 · dedupeInspectNodes test · QA-27/32 真实父/子/recovery session |
...
| Web UI 交互语义（task/button、dialog/menu/listbox、Escape、focus-visible、移动端 sidebar scrim） | ✅ | UJ-24 | INC-23 · frontend build · QA-32 DOM/799/680px |
