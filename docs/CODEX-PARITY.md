...
| SC-06 | run detail/deep link/edit/next run/history | GAP | 2026-07-22 `QA88-98.3r-scheduled-detail/01..10`：Codex row click 真开 split series detail；我方 row click 真开完整 iteration history，hash reload/back 均保真，raw inspect wall 已修为 structured Run details。2026-07-23 `QA88-98.4x/16..17` 复证主线只留 bounded failure summary、Raw run data 仍保留完整 `provider_invalid`；缺 series config/detail/edit/notification projection，见 G56 |
