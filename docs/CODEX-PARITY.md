...
| TH-14 | plan/progress visibility 与完成真实性 | UNTESTED | 2026-07-23 `98.4r`：AgentRunner shared 真模型四步 progress 在 Environment 保持 1/4（done/running/pending/pending），goal pause/resume/budget 不伪造完成；紧凑控制条不再重复 checklist。Codex active goal 已捕获，但 update_plan/replan 的详情逐态仍未捕获，保持 UNTESTED |
