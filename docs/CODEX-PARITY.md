...
| SC-05 | active/paused/finished/failed/overlap/retry | GAP | 2026-07-22 `QA88-98.3p-scheduled/08/11/13/16`：Codex Paused 真显示 `cloc`；我方 Active/Finished 真筛选，但无全局 series pause/resume lifecycle/paused projection，见 G55；不得把 Finished 改名 Paused。2026-07-23 `QA88-98.4x/13..16/20..21` 又真验 failed driver：不再同时给“不接受 follow-up”与普通 Retry，provider 协议噪音从主线收进 Run details；G55 仍开放 |
