...
**98.2c 盘点**：79 行 = `PASS 12 / GAP 5 / INTENTIONAL 4 / BLOCKED 1 /
UNTESTED 57`。PASS 中 New session/Scheduled/Environment 各有多行交叉锚，因此它们
...
| NS-05 | composer textarea：empty/multiline/overflow/IME/CJK | UNTESTED | 2026-07-22 `32` 已覆盖 AgentRunner 28 行 CJK/1026 chars、textarea 180<scrollHeight 609、body 无水平 overflow；Codex 同态与 IME composition 尚缺，不能判 PASS |
...
| NS-08 | access/model/thinking picker：搜索/切换/disabled/error | UNTESTED | 2026-07-22 Codex `09/15` ↔ AgentRunner `30/31` 已覆盖 root；我方 Model/Effort 子页、High→Medium 恢复已真测，disabled/error 与 Codex deeper state 尚缺 |
