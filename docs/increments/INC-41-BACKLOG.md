...
### RD-8 ☐ ≤1280 时 diff 顶栏溢出面板,**✕ 被裁到面板外 → 关不掉 Changes** [P1]
...
### RD-9 ☐ Split view 只渲染旧侧,新增行**整列在面板外** [P1]
...
### TH-14 ☐ composer 上方**两条**常驻终态横幅堆叠,同一件事说三遍,读区被压到 70% [P1]
...
### TH-15 ☐ 按钮叫 "Supervision",打开的面板叫 "Environment";Changes 有两个入口 [P1]
...
### SB-11 ☐ Projects 分组名和 "Show more" 一样灰,整棵树读不出层级 [P1]
...
### SB-12 ☐ Sidebar 页脚把产品名当账户名念了第二遍,单行的事占了两行 [P2]
...
### SB-13 ☐ Sidebar 品牌行 32px 黑色圆角 logo 方块,金标是纯文字 wordmark [P3]
...
### SB-14 ☐ Sidebar 分组头多一个金标没有的次要后缀 [P3]
