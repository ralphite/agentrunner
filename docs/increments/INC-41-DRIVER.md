...
| `codex-pull-requests.jpg` | Pull requests:All/Reviewing/Authored、PR 行 repo/branch +/- | Pull requests |
| `codex-plugins.jpg` | Plugins:搜索、Installed、Featured 网格 + Install | Plugins |
| `codex-sites-empty.jpg` | Sites 空态 | Sites |

**全局 sidebar**(各图皆可见,首要对齐面):New task/Scheduled/Plugins/Sites/
